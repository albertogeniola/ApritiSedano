...
// ==========================================
    ...
    #define HW_ANT_SELECT_PIN   14          // GPIO 14 (LOW = Antenna ceramica integrata, HIGH = Antenna esterna U.FL)
    ...
    #define HW_I2C_SDA          21    // Default I2C SDA (GPIO 21)
    #define HW_I2C_SCL          22    // Default I2C SCL (GPIO 22)
    #define HW_BOOT_PIN         0     // BOOT button on standard WROOM32 dev boards (GPIO 0)
    #define HW_EXTERNAL_BTN_PIN 19    // Esempio: GPIO 19 per pulsante esterno
